...
public class LoginWindow extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnReport.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 102, 102), 1, true));
        ...
        btnLogin.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 102, 102), 1, true));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (txtUsername.getText().equals("123") && txtPassword.getText().equals("123")) {
            ...
            lblMessage.setText("INVAILD USERNAME OR PASSWORD ");
        }
    ...
    private void btnReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReportActionPerformed
        ...
        if (txtUsername.getText().length() != 0 && txtPassword.getText().length() != 0) {
            ...
            lblMessage.setText("FIELD ALREADY BLANKS");
        }
